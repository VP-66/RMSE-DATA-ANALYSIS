...
data_analysis = data_correlation[['Tech_Issues', 'Remote_Productivity']]
data_analysis['Job Satisfaction'] = job_satisfaction
data_analysis['Company Support'] = company_support

print(descriptive_stats_job_satisfaction)
print()
print(descriptive_stats_company_support)

# Calculate correlation matrix for the new set of variables
correlation_matrix_analysis = data_analysis.corr()

# Visualize the correlation matrix using a heatmap
plt.figure(figsize=(10, 8))
sns.heatmap(correlation_matrix_analysis, annot=True, cmap='coolwarm', fmt=".2f", linewidths=.5)
plt.title('Correlation Matrix for Job Satisfaction, Company Support, and Productivity')
plt.show()
